		...
		<div>
			...
			>
				<AppContainer className='relative flex flex-col items-start justify-center h-full'>
					<div className='text-white bg-primary shadow-xl shadow-gray-200/40 inline-block px-4 py-2 mb-4'>
						<p className='uppercase text-[12px]'>Feature</p>
					</div>
					<div className='mb-10'>
						<h1 className='text-white font-normal text-4xl sm:text-4xl md:text-6xl mb-2'>
							Winter Vegetable <br /> Gratin <br />
						</h1>
